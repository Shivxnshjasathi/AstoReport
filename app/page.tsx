...
const dict = {
  en: {
    ...
    toolDosha: "Dosha Analysis",
    toolDoshaDesc: "Calculate Manglik, Sade Sati & Karmic debts",
    ...
    toolGemstones: "Gemstone Guide",
    toolGemstonesDesc: "Find your lucky Ratna",
    toolDasha: "Dasha Timeline",
    toolDashaDesc: "Your life's planetary periods",
    toolYogas: "Yoga Scanner",
    toolYogasDesc: "Detect powerful chart yogas",
    toolNames: "Nakshatra Names",
    toolNamesDesc: "Vedic baby name generator",
    toolCartography: "Astro-Map",
    toolCartographyDesc: "Best global locations for you",
    toolVarshphal: "Yearly Blueprint",
  ...
  hi: {
    ...
    toolDosha: "दोष विश्लेषण",
    toolDoshaDesc: "मांगलिक, साढ़े साती और कर्म ऋण की जांच करें",
    ...
    toolGemstones: "रत्न मार्गदर्शिका",
    toolGemstonesDesc: "अपना भाग्यशाली रत्न खोजें",
    toolDasha: "दशा टाइमलाइन",
    toolDashaDesc: "आपके जीवन की ग्रह अवधि",
    toolYogas: "योग स्कैनर",
    toolYogasDesc: "शक्तिशाली चार्ट योगों का पता लगाएं",
    toolNames: "नक्षत्र नाम",
    toolNamesDesc: "वैदिक बेबी नाम जेनरेटर",
    toolCartography: "एस्ट्रो-मैप",
    toolCartographyDesc: "आपके लिए सर्वश्रेष्ठ वैश्विक स्थान",
    toolVarshphal: "वार्षिक ब्लूप्रिंट",
...
export default function Home() {
  ...
  const toolCategories = {
    ...
    life: [
      ...
      { href: '/names', icon: '👶', title: t.toolNames },
    ],
    solutions: [
      ...
      { href: '/lalkitab', icon: '📖', title: t.toolLalKitab },
    ],
    advanced: [
      { href: '/compare', icon: '📊', title: t.toolCompare },
      { href: '/newsletter', icon: '📱', title: t.toolNewsletter },
      { href: '/blog', icon: '🎯', title: t.toolBlog },
      { href: '/dasha', icon: '⏳', title: t.toolDasha },
      { href: '/yogas', icon: '🌟', title: t.toolYogas },
      { href: '/map', icon: '🗺️', title: t.toolCartography },
      { href: '/yearly', icon: '🌓', title: t.toolVarshphal },
    ]
  } as const;
